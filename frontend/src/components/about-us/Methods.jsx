...
const Methods = () => {
  return (
    <>
      ...
      <div className="bg-richblack-700 py-8 px-4 min-h-[250px]">
      ...
      <div className="bg-richblack-800 py-8 px-4 min-h-[250px]">
        <h4 className="text-white text-[18px] lg:w-[80%]">
      ...
      <div className="lg:col-start-2 bg-richblack-700 py-8 px-4 min-h-[250px]">
